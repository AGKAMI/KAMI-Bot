...
welcome: false,
    ...
    crewTeams: {
      'SSRS': {
        ...
        image: './utils/team_images/ssrs.jpeg',
        description: 'VIP Event Security — protecting the Slammed Society at every event',
        cars: 'Golf 7, Jeep SRT',
      ...
      'KSSPS': {
        ...
        image: './utils/team_images/kssps.jpeg',
        description: 'Close Protection — dedicated to keeping our members safe',
        cars: 'Range Rover Defender',
      ...
      'KSSMP': {
        ...
        image: './utils/team_images/kssmp.jpeg',
        description: 'Patrol Unit — keeping order on the streets',
        cars: 'Mercedes GLE',
      ...
      'KSSMS': {
        ...
        image: './utils/team_images/kssms.jpeg',
        description: 'Management Squad — the backbone of operations',
        cars: 'Golf 7',
        ranks: ['grade e', 'grade d', 'grade c', 'grade b', 'grade a'],
      },
      'SSGENERAL': {
        ...
        invite: '',
        image: '',
        description: 'General crew — all members welcome',
        cars: '',
