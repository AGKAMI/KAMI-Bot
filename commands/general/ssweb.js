...
module.exports = {
  ...
  async execute(sock, msg, args, extra) {
    try {
      if (args.length === 0) {
        return extra.reply('❌ give me a website link hey\n\nExample: .ssweb https://github.com');
      }
      ...
      if (!url.startsWith('http://') && !url.startsWith('https://')) {
        return extra.reply('❌ need a valid url starting with http:// or https://');
      }
      ...
      await extra.reply(`❌ couldn't screenshot that site: ${error.message}`);
    }
  }
};
