...
const SSRS = {
  ...
  age: Array.from({ length: 30 }, (_, i) => {
    const variants = [
      { text: 'How old are you?', opts: ['18','19','20','21','22','23-24','25+'] },
      { text: 'What is your age?', opts: ['18','19-20','21-22','23-25','26-30','31+'] },
      { text: 'Age range?', opts: ['18','19','20','21','22','23-24','25+'] },
      { text: 'How many years old are you?', opts: ['18','19','20','21','22+'] },
      { text: 'What age bracket do you fall in?', opts: ['18-19','20-21','22-24','25-29','30+'] },
      { text: 'Tell us your age:', opts: ['18','19','20','21','22','23-24','25+'] },
      { text: 'How old will you be this year?', opts: ['18','19','20','21','22+'] },
      { text: 'Your age please:', opts: ['18','19-20','21-22','23-25','26-30','31+'] },
      { text: 'What year were you born?', opts: ['2006 (18-19)','2005 (20-21)','2004 (21-22)','2003 or earlier (22+)'] },
      { text: 'Are you 18 or older?', opts: ['Yes — I am 18','Yes — I am 19-20','Yes — I am 21+'] },
      { text: 'Select your age group:', opts: ['18-19','20-21','22-24','25-29','30-35','36+'] },
      { text: 'How old are you right now?', opts: ['18','19','20','21','22','23-24','25+'] },
      { text: 'What is your current age?', opts: ['18','19-20','21-22','23-25','26-30','31+'] },
      { text: 'Please state your age:', opts: ['18','19','20','21','22+'] },
      { text: 'Age?', opts: ['18','19-20','21-22','23-25','26-30','31+'] },
      { text: 'How many years have you been alive?', opts: ['18','19','20','21','22+'] },
      { text: 'Which age group are you in?', opts: ['18-19','20-21','22-24','25-29','30+'] },
      { text: 'What age are you turning this year?', opts: ['18','19','20','21','22+'] },
      { text: 'Your age:', opts: ['18','19-20','21-22','23-25','26-30','31+'] },
      { text: 'How old do you claim to be?', opts: ['18','19','20','21','22+'] },
      { text: 'Date of birth or age?', opts: ['18','19-20','21-22','23-25','26+'] },
      { text: 'Select your age:', opts: ['18','19','20','21','22','23-24','25+'] },
      { text: 'What is your age range?', opts: ['18-19','20-21','22-24','25-30','31+'] },
      { text: 'Old are you?', opts: ['18','19','20','21','22+'] },
      { text: 'Age verification — how old?', opts: ['18','19-20','21-22','23-25','26-30','31+'] },
      { text: 'State your age:', opts: ['18','19','20','21','22+'] },
      { text: 'What age bracket applies to you?', opts: ['18-19','20-21','22-24','25-29','30+'] },
      { text: 'How old are you in years?', opts: ['18','19','20','21','22+'] },
      { text: 'Your current age is:', opts: ['18','19-20','21-22','23-25','26+'] },
      { text: 'What is your age?', opts: ['18','19','20','21','22','23-24','25+'] },
    ];
    const v = variants[i % variants.length];
    const scores = [3, 4, 5, 6, 6, 7, 7];
    return {
      text: v.text,
